...
function ProductModalGalleryTicket(props: any) {
    ...
    return (
        <>
            ...
            >
                {
                    props.ticketResponse.images.map((image: any, index: Key) => {
                        return (
                            <div key={index}>
                                <div
                                    style={{ backgroundImage: `url(${props.ticketResponse.imagesBaseUrl}${image})` }}
...
export default ProductModalGalleryTicket;