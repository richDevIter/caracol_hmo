...
const SlowBuyTour: React.FC<propOptions> = ({ tourResponse, lng, dic }: propOptions) => {
    ...
    const handleClick = (controll: string, faixa: string) => {
        console.log(dateTour[modalityNumber].maxStockNumber);
    ...
    console.log(dateTour[modalityNumber])
                            ...
                            <div className="">
                                <div className="panel-dropdown-content right active">
                                    <div className={`${styles.select_date}`}>
                                        ...
                                        <div className={`${styles.calendar_input} mb-5`}>
                                            {showCalendar === true ? (
                                                <>
                                                    <p style={{ fontSize: '18px', color: '#707070' }}>
